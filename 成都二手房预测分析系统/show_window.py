...
class Main(QMainWindow, Ui_MainWindow):
    ...
    # # 新增功能
    # # 显示全市二手房楼房结构分析
    # def show_LouFangJieGou(self):
    #     type, number = house_analysis.get_LouFangJieGou()  # 获取全市房子楼房结构
    #     chart.LouFangJieGou_bar(type, number, '全市二手房装修程度分析')  # 显示图表

    # # 新增功能
    # # 显示全市二手房房源发布时间分析
    # def show_FangYuanFaBuXingXi(self):
    #     type, number = house_analysis.get_FangYuanFaBuXingXi()  # 获取全市房子楼房结构
    #     chart.FangYuanFaBuXingXi_bar(type, number, '全市二手房房源发布时间分析')  # 显示图表
...
if __name__ == "__main__":
    ...
    # # 新增功能
    # # 显示全市二手房楼房结构分析图，按钮事件
    # main.btn_6.triggered.connect(main.show_LouFangJieGou)

    # # 新增功能
    # # 显示全市二手房房源发布时间分析图，按钮事件
    # main.btn_7.triggered.connect(main.show_FangYuanFaBuXingXi)
