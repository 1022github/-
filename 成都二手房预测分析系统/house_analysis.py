...
# # 新增功能
# # 获取全市二手房楼房结构对比
# def get_LouFangJieGou():
#     group_LouFangJieGou = data.groupby('楼房结构').size()  # 将房子楼房结构分组并统计数量
#     type = group_LouFangJieGou.index  # 楼房结构
#     number = group_LouFangJieGou.values  # 楼房结构对应的数量
#     return type, number  # 返回楼房结构与对应的数量

# # 新增功能
# # 获取全市二手房房源发布时间对比
# def get_FangYuanFaBuXingXi():
#     group_FangYuanFaBuXingXi = data.groupby('房源发布时间').size()  # 将房子房源发布时间分组并统计数量
#     type = group_FangYuanFaBuXingXi.index  # 房源发布时间
#     number = group_FangYuanFaBuXingXi.values  # 房源发布时间对应的数量
#     return type, number  # 返回房源发布时间与对应的数量